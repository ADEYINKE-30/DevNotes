...
export const mockForumPosts: ForumPost[] = [
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: "like", count: 5, users: ["user-1", "user-3"] }],
      },
      {
        id: "c2",
        ...
        reactions: [{ emoji: "like", count: 3, users: ["user-2"] }, { emoji: "love", count: 1, users: ["user-1"] }],
      },
    ],
    reactions: [
      { emoji: "like", count: 12, users: ["user-1", "user-2", "user-3"] },
      { emoji: "love", count: 7, users: ["user-1", "user-4"] },
      { emoji: "rocket", count: 3, users: ["user-3"] },
    ],
    viewCount: 234,
    isPinned: true,
  },
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: "like", count: 8, users: ["user-2", "user-3"] }],
      },
    ],
    reactions: [
      { emoji: "like", count: 15, users: ["user-1", "user-3", "user-5"] },
      { emoji: "idea", count: 4, users: ["user-4"] },
    ],
    viewCount: 189,
    isPinned: false,
  },
  {
    ...
    comments: [],
    reactions: [
      { emoji: "award", count: 20, users: ["user-1", "user-2", "user-3", "user-4"] },
      { emoji: "flame", count: 10, users: ["user-1", "user-5"] },
    ],
    viewCount: 345,
    isPinned: false,
  },
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: "like", count: 4, users: ["user-1"] }],
      },
    ],
    reactions: [
      { emoji: "like", count: 8, users: ["user-1", "user-2"] },
    ],
    viewCount: 156,
    isPinned: false,
  },
